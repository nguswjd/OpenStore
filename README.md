...
<div>
  ...
  <img src="./readme-Image/JavaScript.png" width="80">
</div>
...
📦OpenStore
 ...
 ┣ 📂css                               
 ┃ ┣ 📜reset.css
 ┃ ┣ 📜style.css              # 로그인 페이지, 회원가입 페이지, 제품 상세 페이지 제외 스타일 css 
 ┃ ┣ 📜login-join.css         # 로그인 페이지, 회원가입 페이지 스타일 css 
 ┃ ┣ 📜product_details.css    # 제품 상세 페이지 스타일 css 
 ┃ ┗ 📜404.css                # 404 페이지 스타일 css 
 ┣ 📂js
 ┃ ┣ 📜api.js                 # api 모음 
 ┃ ┣ 📜DOM.js                 # DOM 모음 
 ┃ ┣ 📜main.js
...
<table style="width: 700px; min-width: 700px; table-layout: fixed; margin: 0 auto;">
  ...
  <tr>
    <td style="text-align: center;">
      ...
      <img src="./readme-Image/screen/비사용자-헤더.png" width="500px"><br><br>
  ...
  <tr>
    <td style="text-align: center;">
      ...
      <img src="./readme-Image/screen/판매자-헤더.png" width="500px"><br><br>
...
<table style="width: 700px; min-width: 700px; table-layout: fixed; margin: 0 auto;">
  ...
  <tr>
    <td style="text-align: center;">
      <img src="./readme-Image/screen/openModal.gif" width="500px"><br><br>
...
<table style="width: 700px; min-width: 700px; table-layout: fixed; margin: 0 auto;">
  ...
  <tr>
    <td style="text-align: center;">
      <img src="./readme-Image/screen/index-product.png" width="500px"><br><br>
...
<table style="width: 700px; min-width: 700px; table-layout: fixed; margin: 0 auto;">
  ...
  <tr>
    <td style="text-align: center;">
      <img src="./readme-Image/screen/logout-userInfo.gif" width="500px"><br><br>
...
<table style="width: 700px; min-width: 700px; table-layout: fixed; margin: 0 auto;">
  ...
  <tr>
    <td style="text-align: center;">
      <img src="./readme-Image/screen/productclick.gif" width="500px"><br><br>
...
<table style="width: 700px; min-width: 700px; table-layout: fixed; margin: 0 auto;">
  ...
  <tr>
    <td style="text-align: center;">
      <img src="./readme-Image/screen/dec-incBtn.gif" width="500px"><br><br>
...
<table style="width: 700px; min-width: 700px; table-layout: fixed; margin: 0 auto;">
  ...
  <tr>
    <td style="text-align: center;">
      <img src="./readme-Image/screen/productModal.gif" width="500px"><br><br>
...
<table style="width: 700px; min-width: 700px; table-layout: fixed; margin: 0 auto;">
  ...
  <tr>
    <td style="text-align: center;">
      <img src="./readme-Image/screen/reviewBtn.gif" width="500px"><br><br>
...
<table style="width: 700px; min-width: 700px; table-layout: fixed; margin: 0 auto;">
  ...
  <tr>
    <td style="text-align: center;">
      <img src="./readme-Image/screen/login.gif" width="500px"><br><br>
...
<table style="width: 700px; min-width: 700px; table-layout: fixed; margin: 0 auto;">
  ...
  <tr>
    <td style="text-align: center;">
      <img src="./readme-Image/screen/join-clickBtn.gif" width="500px"><br><br>
...
<table style="width: 700px; min-width: 700px; table-layout: fixed; margin: 0 auto;">
  ...
  <tr>
    <td style="text-align: center;">
      <img src="./readme-Image/screen/join.gif" width="500px"><br><br>
